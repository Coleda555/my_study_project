...
class Graph:
    ...
    def __init__(self, data, is_show=True):
        ...
        self.text_data = (' '.join(map(lambda num: str(num), self.data)))
    ...
    def show_table(self):
        ...
        if self.is_show == False:
            text = "Отображение данных закрыто"
        print(text)
    ...
    def show_graph(self):
        ...
        if self.is_show == False:
            text = "Отображение данных закрыто"
        print('Графическое отображение данных: {}'.format(text))

    def show_bar(self):
        text = self.text_data
        if self.is_show == False:
            text = "Отображение данных закрыто"
        print('Столбчатая диаграмма: {}'.format(text))
