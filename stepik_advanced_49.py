...
dict_numbers = {}
for _ in range(n):
    list_input = [item for item in input().split()]
    if list_input[1].lower() in dict_numbers:
        dict_numbers[list_input[1].lower()].append(list_input[0])
    else:
        dict_numbers[list_input[1].lower()] = [list_input[0]]
print(dict_numbers)
m = int(input())
for _ in range(m):
    name = input().lower()
