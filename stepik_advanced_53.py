...
Для каждого слова исходного текста программа выводит одно целое число — номер вхождения этого слова в текст. Числа
необходимо выводятся на одной строке, через пробел.
...
for word in list_input:
    if word not in list_check:
        list_check.append(word)
        list_output.append(1)
    else:
        list_check.append(word)
        list_output.append(list_check.count(word))
print(*list_output)
