...
Примечание 2. Обратите внимание, что заглавные буквы должны заменяться на соответствующие им заглавные же буквы, но
 если транслитерационная последовательность состоит из нескольких символов, то заглавным будет только первый из них:
  «С» на «S», а «Я» на «Ya».
...
for ch in cyrillic:
    if ch in translate_dict:
        result_translate += translate_dict[ch]
    else:
        result_translate += ch

with open('transliteration.txt', 'w', encoding='utf-8') as output:
    output.write(result_translate)
